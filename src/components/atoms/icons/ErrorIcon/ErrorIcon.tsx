...
import ErrorIconProps from './protocols/ErrorIcon.model'
...
const ErrorIcon: React.FC<ErrorIconProps> = (props) => {
  ...
  return (
    <svg className={errorIconStyle} viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-testid="error-icon">
      <path
